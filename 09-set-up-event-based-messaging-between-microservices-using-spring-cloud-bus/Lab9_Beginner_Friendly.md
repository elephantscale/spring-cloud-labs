...
| **3** | Click **Add file → Create new file**<br>• **Filename** → `user-service.properties`<br>• Paste the snippet below, then click **Commit new file**<br><br>```properties
<br>message=Hello from Config Server!<br>
``` | File appears in the repo |
