...
| | **Select dependencies** | **Spring Web**, **Spring Boot Actuator**, <br> **Micrometer Tracing (Brave)**, **Zipkin Reporter (Brave)** (Will add manually) |
...
| | **Select dependencies** | **Spring Web**, **Spring Reactive Web**, **Spring Boot Actuator**, <br> **Micrometer Tracing (Brave)**, **Zipkin Reporter (Brave)** (Will add manually) |
