...
| B | **Add your project code**<br>`cd path\to\generated\user-service` *(Spring Initializr output)* | Inside project directory |
...
| B | **Add your project code**<br>`cd path\to\generated\order-service` | Inside project directory |
