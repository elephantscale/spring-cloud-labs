...
|------|------------|-----------------|
| 4 | **Create the repo with a README**<br>`gh repo create user-service --public --add-readme --confirm` | Repo URL printed; local folder **user-service** created |
| 5 | **Add your project code**<br>`cd path\to\generated\user-service` *(Spring Initializr output)* | Inside project directory |
| 6 | **Commit & push**<br>`git add .`<br>`git commit -m "Initial commit – user-service"`<br>`git push -u origin main` | Push completes; branch **main** on GitHub |

#### GitHub CLI — `order-service`

| Step | What to do | Expected Result |
|------|------------|-----------------|
| 7 | **Create the repo with a README**<br>`gh repo create order-service --public --add-readme --confirm` | Repo URL printed; local folder **order-service** created |
| 8 | **Add your project code**<br>`cd path\to\generated\order-service` | Inside project directory |
| 9 | **Commit & push**<br>`git add .`<br>`git commit -m "Initial commit – order-service"`<br>`git push -u origin main` | Push completes; branch **main** on GitHub |
