...
## 8.3  Validate replicas (pick **either** quick or detailed view)
...
### ▶ Detailed live view (shell‑agnostic)
...
kubectl describe deployment order-service | grep -i Replicas
...
*(Repeat for `user-service` if desired.)*
